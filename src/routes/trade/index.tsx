...
function TradeSelectionScreen() {
  ...
  const handleNext = () => {
    if (selected) {
      navigate({ to: '/trades/$tradeId', params: { tradeId: selected } });
    }
  };
    ...
    <>
      ...
      <div className="slide-wrap">
        ...
        <div className="slide-body">
          ...
          <p className="slide-subtitle anim" style={{ animationDelay: '0.04s' }}>
            Select the type of work. We'll guide you through the details.
          </p>

          <div className="option-list anim" style={{ animationDelay: '0.08s', width: '100%' }}>
            {TRADE_OPTIONS.map((t) => (
              <button
                key={t.id}
              ...
              >
                <div
                  ...
                  style={
                    selected === t.id
                      ? { background: 'white', borderColor: t.color.accent + '50' }
                      : {}
                  }
                >
                  {t.icon}
            ...
            >
              <div className="option-icon" style={{ background: T.purple, border: 'none', color: 'white' }}>
                🏗️
              </div>
              <div>
                ...
                <div className="option-text-sub">Bathroom reno or new building construction</div>
              </div>
            </button>
          </div>
        </div>
